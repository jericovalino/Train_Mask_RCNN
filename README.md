...
In the CMD, change directories to the "C:\Train_Mask_RCNN\models\research" directory and copy and paste the following command into the command line and press Enter:
